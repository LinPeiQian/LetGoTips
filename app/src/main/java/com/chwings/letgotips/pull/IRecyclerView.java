...
public class IRecyclerView extends RecyclerView {
    ...
    public IRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            refreshHeaderLayoutRes = a.getResourceId(R.styleable.IRecyclerView_refreshHeaderLayout, R.layout.header_refresh);
            loadMoreFooterLayoutRes = a.getResourceId(R.styleable.IRecyclerView_loadMoreFooterLayout, R.layout.foot_load);
